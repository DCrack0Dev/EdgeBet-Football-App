...
export default function SubscriptionPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      cta: isPremium ? 'Manage Subscription' : 'Unlock Premium Access',
              ...
              <div className="space-y-4">
                {plan.name === 'Premium' && !isPremium ? (
                  <Button 
                    ...
                    className="w-full h-16 font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-primary/20 group"
                  >
                    {plan.cta} <ChevronRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </Button>
                ) : (
                  <Button 
                    variant={plan.variant} 
                    className={cn(
                      "w-full h-16 font-black text-xs uppercase tracking-[0.2em] group",
                      plan.isCurrent && "opacity-50 cursor-default pointer-events-none"
                    )}
                  >
                    {plan.cta} {plan.name === 'Premium' && isPremium && <Settings className="w-4 h-4 ml-2" />}
                  </Button>
                )}
